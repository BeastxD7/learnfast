  ...
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      <div className={cn(
        ...
        Collaborate, manage projects, and reach new productivity peaks. From high rises to the home office, the way your team works is unique - accomplish it all with NeurAI-Tasks.
      </div>
